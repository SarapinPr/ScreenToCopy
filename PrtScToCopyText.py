...
def start_application():
    ...
    window.pixmap = QApplication.primaryScreen().grabWindow(QApplication.desktop().winId())
    window.label.setPixmap(window.pixmap)
    window.label.setAlignment(Qt.AlignTop)
    window.label.mousePressEvent = window.mousePressEvent
    window.label.mouseMoveEvent = window.mouseMoveEvent
    window.label.mouseReleaseEvent = window.mouseReleaseEvent
    window.show()
    app.exec_()


if __name__ == "__main__":
    print("Press the 'PrtSc' key to take a screenshot.")
    while True:
